<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Upload_Item.aspx.cs" Inherits="Upload_Item" %>
...
<div id="body-wrapper" class="clearfix"><!--start body-wrapper-->
	...
	<div class="box">
		...
		<li class="current"><a href="Faculty/Details_faculty.aspx">Details </a></li>
        <li><a href="Chat/Default.aspx">Chat</a></li>
        <li><a href="Faculty/Moodle.aspx">Moodle</a></li>
		<li><a href="Upload_Item.aspx">Upload File</a></li>
        <li><a href="Faculty/PostTopic.aspx">Post Topic</a></li>
		<li><a href="Faculty/Addbatch_Faculty.aspx">Add Batch</a></li>
		<li><a href="Faculty/Profile_faculty.aspx">Profile</a></li>
		<li><a href="Faculty/Registration_faculty.aspx">Registration</a></li>
		<li><a href="Faculty/faculty_Home.aspx">Home</a></li>
	</ul>
    Welcome 
   ...
   <table border="0" cellpadding="3" cellspacing="0" style="Width:auto;" align="center" ><tr>
       <th align="center" colspan="2" class="style7"><h1><b>Upload Assigment</b></h1></th></tr>
<tr><td align="left" class="style3">Select Branch</td><td class="style4">
    <asp:DropDownList ID="DropDownList1" runat="server"  >
    <asp:ListItem Value="Computer Engineering">Computer Engineering</asp:ListItem>
    <asp:ListItem Value="Infomation Technogy"></asp:ListItem>
    </asp:DropDownList>
</td></tr>
<tr><td class="style5">Semester</td><td class="style6">
    <asp:DropDownList ID="DropDownList2" runat="server">
        <asp:ListItem Value="1st semester">1st Semsester</asp:ListItem>
        <asp:ListItem Value="2nd semester">2nd Semsester</asp:ListItem>
        <asp:ListItem Value="3rd semester">3rd Semsester</asp:ListItem>
        <asp:ListItem Value="4th semester">4th Semsester</asp:ListItem>  
        <asp:ListItem Value="5th semester">5th Semsester</asp:ListItem>
        <asp:ListItem Value="6th semester">6th Semsester</asp:ListItem>
        <asp:ListItem Value="7th semester">7th Semsester</asp:ListItem>
        <asp:ListItem Value="8th semester">8th Semsester</asp:ListItem>

    </asp:DropDownList>
</td></tr>
<tr><td align="left">Selece Date</td>
<td class="style2">
    <asp:TextBox ID="txtDate" runat="server" Height="21px" Width="157px">Select Date</asp:TextBox>
...
<tr><td>Select File</td><td class="style1">
    <asp:FileUpload ID="FileUpload1" runat="server" />
</td></tr>

<tr><td colspan="2" align="center">
    <asp:LinkButton ID="Upload" runat="server" CssClass="button small black" 
        onclick="Upload_Click">Upload Assigment</asp:LinkButton>
    <br />
    <br />
    </td></tr>
</table>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Questionchoise.aspx.cs" Inherits="Questionchoise" %>
...
<div id="body-wrapper" class="clearfix"><!--start body-wrapper-->
	...
	<div class="box">
     ...
     <tr><th colspan="5" align="center" class="style2"><h1 dir="ltr">&nbsp;</h1>
         <h1 dir="ltr">Question Answer</h1></th></tr>
     <tr><td align="left">User Name</td>
     <td align="left" class="style3">
         <asp:TextBox ID="Enrollmentno" runat="server" ReadOnly="True" Width="194px"></asp:TextBox> </td></tr>
         <tr><td align="left">Sequrity Question:</td><td class="style1">
             <asp:TextBox ID="question" runat="server" ReadOnly="True" Width="196px"></asp:TextBox>
             </td></tr>
         <tr><td align="left">Answer</td><td align="left" class="style3">
             <asp:TextBox ID="Answer" runat="server" Width="194px"></asp:TextBox>
             <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                 ControlToValidate="Answer" ErrorMessage="Answer Required" ForeColor="Red"></asp:RequiredFieldValidator>
             </td></tr>
             <tr><td>

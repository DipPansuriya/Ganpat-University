<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Reset_student.aspx.cs" Inherits="Reset_student" %>
...
<div id="body-wrapper" class="clearfix"><!--start body-wrapper-->
	...
	<div class="box">
     ...
     <tr><th colspan="5" align="center"><h1 dir="ltr">&nbsp;</h1>
         <h1 dir="ltr">Reset Password.</h1></th></tr>
   
     <tr><td align="left">User Name</td><td align="left" class="style5">
     ...
     <tr><td align="left">PassWord</td><td align="left" class="style5">
         <asp:TextBox ID="Password" runat="server" TextMode="Password"></asp:TextBox>
         <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
             ControlToValidate="Password" ErrorMessage="Password Required" ForeColor="Red"></asp:RequiredFieldValidator>
         </td></tr>
     <tr><td align="left">Confirm PassWord</td><td align="left" class="style5">
    ...
    <tr><td align="center" colspan="2" class="style4">
        <asp:LinkButton ID="LinkButton1" runat="server" CssClass="button small black" 
            onclick="LinkButton1_Click" >Reset Password</asp:LinkButton>
      </table> 
      </div>
    <!--Nivo Slider-->
 <br />

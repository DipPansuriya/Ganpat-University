<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Faculty_Post_Query.aspx.cs" Inherits="Faculty_Faculty_Post_Query" %>
...
<div id="body-wrapper" class="clearfix"><!--start body-wrapper-->
    ...
    Welcome  (<asp:LinkButton ID="LinkButton1" runat="server" onclick="LinkButton1_Click">Logout</asp:LinkButton>)
       ...
       <div align="center" class="abc"> 
             <a href="Add_Comment_Faculty.aspx?replyTo=0">Add Comment</a>
             <br/>
             <br/>
             <br/>

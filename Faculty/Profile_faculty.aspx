<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Profile_faculty.aspx.cs" Inherits="Profile_faculty" %>
...
<tr><th align="center" colspan="2"><h1>
    Profile
</h1></th></tr>
    <tr><td align="left"  valign="middle">Picture</td><td>
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            Height="123px" Width="133px" GridLines="None" >
               <Columns>
                
           <asp:TemplateField>
           <ItemTemplate>
            <asp:Image ID="Image1" runat="server" Height="123px" 
                    ImageUrl='<%# "Handler.ashx?id="+ Eval("id") %>' Width="133px" />
           </ItemTemplate>
           </asp:TemplateField>
...
<tr><td align="left">Faculty Name:</td><td>
    <asp:TextBox ID="name" runat="server" Width="243px"></asp:TextBox></td></tr>
        
       
        <tr><td align="left">Father's/Hasbound Name:</td><td>
      ...
      <tr><td align="left">Qualified Branch:</td><td>
        ...
        <tr><td align="left">Post</td><td>
            <asp:TextBox ID="Post" runat="server" ReadOnly="True" Width="243px"></asp:TextBox>
        </td></tr>
        <tr><td align="left">Experience</td><td>
            <asp:TextBox ID="Experience" runat="server" ReadOnly="True" Width="241px"></asp:TextBox> 
        </td></tr>
             
             <tr><td align="left">Address:</td><td>
            <asp:TextBox ID="address" runat="server" Width="246px" TextMode="SingleLine" 
                       Height="34px"   CssClass="textbox" ReadOnly="True"></asp:TextBox></td></tr>
       ...
       <tr><td align="left">Specilist Subject</td><td>
           <asp:TextBox ID="Subject" runat="server" TextMode="SingleLine" ReadOnly="True" 

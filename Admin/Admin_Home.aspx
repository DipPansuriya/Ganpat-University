...
<div id="body-wrapper" class="clearfix"><!--start body-wrapper-->
	...
	<div class="box">
		...
		<li><a href="Student_panel.aspx">Student</a></li>
		<li><a href="Faculty_panel.aspx">Faculty</a></li>
	...
	<div class="one_fourth"><!--start top half content-->
	  <div class="fancy"><a id="Moodle" href="Moodle.aspx"><img alt="Moodle" src="../images/Moodle.png" /></a></div>
	</div>
	<div class="one_fourth">
		<div class="fancy"><a id="fancybox" href="../images/210-150-1.png"><img alt="fancybox" src="../images/210-150-1.png" /></a></div>
	</div>
	<div class="one_fourth">
		<div class="fancy"><a id="chat" href="../Chat/Default.aspx"><img alt="fancybox" src="../images/210-150-2.png" /></a></div>
	</div>
	<div class="one_fourth column-last">
		<div class="fancy"><a id="Post" href="../Faculty/Faculty_Post_Query.aspx"><img alt="fancybox" src="../images/210-150-3.png" /></a></div>
	</div><!--end top half content-->

	<div class="clear"></div>

	<div class="one_fourth">
		<a href="Moodle.aspx"><h3>Moodle</h3>
	...
	<div class="one_fourth">
		<a href="../Chat/Default.aspx"><h3>Knowled Corner.</h3>
		<p>Donec metus leo, elementum at ultrices ac, dapibus at justo. Donec tristique hendrerit dui vitae lacinia. Suspendisse ante ligula, adipiscing porta aliquam et, rutrum nec lectus. Nulla erat risus, molestie non dapibus ac, fermentum vitae felis.</p></a>
	</div>
	<div class="one_fourth column-last">
		<a href="../Faculty/Faculty_Post_Query.aspx"><h3>May I Help You?</h3>
		<p>Donec metus leo, elementum at ultrices ac, dapibus at justo. Donec tristique hendrerit dui vitae lacinia. Suspendisse ante ligula, adipiscing porta aliquam et, rutrum nec lectus. Nulla erat risus, molestie non dapibus ac, fermentum vitae felis.</p></a>
	</div>
   </div>
    <br />

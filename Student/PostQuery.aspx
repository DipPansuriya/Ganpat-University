<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PostQuery.aspx.cs" Inherits="PostQuery" %>
...
<div id="body-wrapper" class="clearfix"><!--start body-wrapper-->
    ...
    <div style="padding-top:40px; display:block;" class="slider-wrapper theme-default">
        ...
        <div style="float:left; padding-left:30px; display:block; height:300px;">
         <h1 style="margin-top:30px; font-size:30px; line-height:35px;"><br/>MISSION...<br/></h1>
...
<td>
    <asp:Label ID="Label2" runat="server" Text='<%#Eval("no") %>'></asp:Label> </td>
</tr> 
</table> 
</td> 
</tr>

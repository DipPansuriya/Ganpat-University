<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Student_Post_Query.aspx.cs" Inherits="Faculty_Faculty_Post_Query" %>
...
.social-popout img:hover {
	...
	#ContentWraper
        ...
        .Arrow
        {
            background: url('arrow_up_left.png') no-repeat left top;
            display: block;
            width: 25px;
            height: 45px;
            float: left;
...
<div id="body-wrapper" class="clearfix"><!--start body-wrapper-->
    ...
    Welcome  (<asp:LinkButton ID="LinkButton1" runat="server" onclick="LinkButton1_Click">Logout</asp:LinkButton>)
       ...
       <div align="center" class="abc"> 
             <a href="Add_Comment_Student.aspx?replyTo=0">Add Comment</a>
             <br/>
             <br/>
             <br/>

...
<div id="body-wrapper" class="clearfix"><!--start body-wrapper-->
 ...
 <div><div class="abc" align="center">
     ...
     <tr><th colspan="5" align="center"><h1 dir="ltr">&nbsp;</h1>
         <h1 dir="ltr">Login Here</h1></th></tr>
         <tr><td  align="left">Select</td><td align="left">
     ...
     <tr><td align="left">User Name</td><td align="left"><asp:TextBox ID="Username" runat="server"></asp:TextBox>
     <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
             ControlToValidate="Username" ErrorMessage="*" 
             ForeColor="Red"></asp:RequiredFieldValidator>
     </td></tr>
     <tr><td class="style5" align="left">Pass Word</td><td align="left">
    ...
    <%--<a class="button small black" href="Registration.aspx"> Contact Us </a>--%></td></tr>
    <tr><td align="center" colspan="2"><a href="Verify_student.aspx">New Member?</a></td></tr>
    <tr><td align="center" colspan="2"><a href="Choise.aspx"> Forget Password?</a></td>
      </table> 
      </div>
      </div>

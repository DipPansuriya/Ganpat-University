<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Download_Items.aspx.cs" Inherits="Student_Uploaded_Items" %>
...
<div id="body-wrapper" class="clearfix"><!--start body-wrapper-->
    ...
    <asp:GridView ID="gvDetails" CssClass="Gridview" runat="server" 
            AutoGenerateColumns="false" DataKeyNames="FilePath" BorderColor="Red" 
            BorderStyle="Solid" BorderWidth="2px" Caption="Uploded Items" 
            Width="712px" AllowPaging="True">
        <EditRowStyle HorizontalAlign="Center" VerticalAlign="Middle" />
<HeaderStyle BackColor="#df5015" Height="30px" HorizontalAlign="Center" 
...
<asp:BoundField DataField="FileName" HeaderText="FileName" />
   ...
   <asp:TemplateField HeaderText="Delete">
                <ItemTemplate>
                    <asp:ImageButton ID="lnkDownload" runat="server"  ImageUrl="~/del.png"
                         OnClick="lnkDownload_Click" AlternateText="Download" Height="30px" ImageAlign="TextTop" />
                </ItemTemplate>
                </asp:TemplateField>


</Columns>
        <PagerStyle Font-Bold="True" ForeColor="Red" HorizontalAlign="Center" 
            VerticalAlign="Middle"/>

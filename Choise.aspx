<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Choise.aspx.cs" Inherits="Choise" %>
...
<div id="body-wrapper" class="clearfix"><!--start body-wrapper-->
 ...
 <div><div class="abc" align="center">
        <table>
        <tr><th align="center" colspan="2"><img src="ForgotPassword_Icon.png" alt="Forget"/></th></tr>

        <tr><td align="right"><img src="Email_mail_envelope_letter_send_inbox_newsletter.png"></td><td align="left"> <a href="Password_Mail.aspx">Get Your Password From Your Email.</a></td></tr>
        <tr><td align="right"><img src="icon-windows-security-question.png"></td><td align="left"><a href="ForgetPassword_student.aspx">Give Security Question Answer.</a></td></tr>

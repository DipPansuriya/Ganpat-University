<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Password_Mail.aspx.cs" Inherits="Password_Mail" %>
...
<div id="body-wrapper" class="clearfix"><!--start body-wrapper-->
 ...
 <div><div class="abc" align="center">
        <table>
        <tr><th align="center" colspan="2"><h1>&nbsp;</h1>
            <h1>Mail....</h1></th></tr>
        <tr><td>Enrollment No</td><td class="style10">
            <asp:TextBox ID="Enrollmentno" runat="server"></asp:TextBox>
        </td></tr>
        <tr><td>Email ID</td><td class="style10">
        ...
        <tr><td></td><td class="style10">
            <asp:LinkButton ID="LinkButton1" runat="server" CssClass="button small black" 
                onclick="LinkButton1_Click">Send Mail</asp:LinkButton>
        </td></tr>
        </table>
      </div>
      </div>
